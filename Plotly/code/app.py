...
def update_graphs(selected_row_ids, selected_rows):  # n_clicks
    ...
    smr_no_list = df_update_smr_info["SMR No"].tolist()
    act_worktime_list = df_update_smr_info["Actual Working Time[h]"].tolist()
    remain_worktime_list = df_update_smr_info["Remain Working Time[h]"].tolist()
    plan_worktime_list = df_update_smr_info["Planned Working Time[h]"].tolist()
    smr_start_day_list = df_update_smr_info["SMR START"].tolist()
    smr_end_day_list = df_update_smr_info["SMR Fix"].tolist()
